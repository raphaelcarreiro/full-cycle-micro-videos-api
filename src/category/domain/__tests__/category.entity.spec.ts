...
describe('Category validation tests', () => {
  describe('create command', () => {
    it('should throw an error when name property is invalid', () => {
      ...
      expect(() => Category.create({ name: 'Movie', is_active: 10 as any })).containsErrorMessages({
        is_active: ['is_active must be a boolean value'],
      });

      expect(() => Category.create({ name: 'Movie', description: 10 as any })).containsErrorMessages({
